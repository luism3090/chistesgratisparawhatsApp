    ...
    <br>
        ...
        <div class="content row" >
               <div class="col-xs-12">
                         ...
                         <select class="form-control" id="slCategoria" name="slCategoria">
                          ...
                          <option value="26">CORONAVIRUS</option>
                          <option value="27">HALLOWEEN</option>
                          <option value="28">Política</option>
                          <option value="29">Año Nuevo</option>
                          <option value="30">Día del amor y la amistad</option>
                          <option value="50">CHISTES COMUNIDAD</option>
                         </select>
                          <br>
                </div>
        ...
        <br>
          <div class="content row" >
               <div class="col-xs-12">
                  <center>
                    <button id='btnCrearChistes' name="btnCrearChistes"  class="btn btn-primary" style="width:150px;height:50px;font-size:20px;font-weight:bold;background-color:green;cursor:pointer">Crear Chiste</button>
                  </center>
               </div>
          </div>
